<!DOCTYPE html>
<html class=" js csstransforms3d csstransitions csstransformspreserve3d" lang="en"><head>
		<meta charset="UTF-8">
		...
		<!-- Default Colour CSS -->
		<link id="theme-color" rel="stylesheet" type="text/css" href="css/theme-colors/dark.css">
		
		<!-- PreLoader -->
    <script style="" src="//www.google-analytics.com/analytics.js" async=""></script><script src="js/modernizr.custom.js"></script>
...
<link href="bootstrap/css/bg.css" rel="stylesheet">
	...
	<script src="http://maps.google.com/maps-api-v3/api/js/22/12/common.js" charset="UTF-8" type="text/javascript"></script><script src="http://maps.google.com/maps-api-v3/api/js/22/12/util.js" charset="UTF-8" type="text/javascript"></script><script src="http://maps.google.com/maps-api-v3/api/js/22/12/stats.js" charset="UTF-8" type="text/javascript"></script></head>
...
<div class="pace-activity"></div></div>
		...
		<div class="container">
			...
			<div class="bb-custom-wrapper">
			  <div id="bb-bookblock" class="bb-bookblock bb-vertical">
				...
				<!-- First page, your photo and title -->
				  <div style="display: block;" class="bb-item" id="page-0">
              ...
              <div class="col-xs-8 col-xs-offset-2 text-center">
                ...
                <p id="navigation-help">
					...
					<!-- About -->
					<div style="display: none;" class="bb-item" id="page-1">
					...
					<!-- Education -->
					<div style="display: none;" class="bb-item" id="page-2">
						<div class="bb-custom-side">
							<div class="bb-custom-container">							
					...
					<!-- Experience -->
					<div style="display: none;" class="bb-item" id="page-3">
					...
					<!-- Skills -->
					<div style="display: none;" class="bb-item" id="page-4">
						<div class="bb-custom-side">
							<div class="bb-custom-container">
                ...
                <div class="row">        
                  ...
                  <div class="col-xs-12 col-sm-4 animateFadeInUp">
					...
					<!-- Portfolio -->
					<div style="display: none;" class="bb-item" id="page-5">
          ...
          <!-- /Portfolio -->
					...
					<!-- Contact -->
					<div style="display: none;" class="bb-item" id="page-6">
						<div class="bb-custom-side">
							<div class="bb-custom-container">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div id="contact-map"><img class="img-thumbnail" src="http://maps.googleapis.com/maps/api/staticmap?center=-12.043333,-77.028333&amp;size=610x300&amp;sensor=true&amp;zoom=15&amp;scale=1"></div>
